...
<head>
    ...
    <link href="assets/css/proposal-form.css?id=1" rel="stylesheet">
...
<div class="container mt-4">
    <div class="card shadow-lg">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="bi bi-pencil-square"></i> Proposal Approval</h5>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="border p-2 rounded text-center">
                            <span class="fw-bold text-primary"><?php echo htmlspecialchars($proposal_id); ?></span>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="approval_status" name="status" required onchange="toggleReasonField()">
                                ...
                                <option value="Approved">Ask for More Details</option>
                        ...
                        <div class="col-md-4 d-none" id="reason_section">
                            ...
                            <select class="form-select" id="reject_reason" name="reject_reason">
                                ...
                                <option value="Credit Score Issue">Credit Score Issue</option>
